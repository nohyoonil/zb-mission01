...
public class WifiInfo implements Comparable<WifiInfo> {
    ...
    @Override
    public int compareTo(@NotNull WifiInfo o) {
        if (o.DISTANCE - this.DISTANCE >= 0) return -1;
        else return 1;
    }

    public double getDISTANCE() {
        return Math.round(DISTANCE * 10000) / 10000d;
    }
    ...
    public String getWORK_DTTM() {
        return WORK_DTTM.format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss.S"));
    }
    ...
    public void setWORK_DTTM(String WORK_DTTM) {
        this.WORK_DTTM = LocalDateTime.parse(WORK_DTTM, DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss.S"));
    }
}
